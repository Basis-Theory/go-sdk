...
package agentic_payment_credentials_test
...
func TestAgenticPaymentCredentialsListWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.Agentic.PaymentCredentials.List(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestAgenticPaymentCredentialsListWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestAgenticPaymentCredentialsListWithWireMock", "GET", "/agentic/payment-credentials", map[string]interface{}{"size": "1", "start": "start"}, 1)
}
