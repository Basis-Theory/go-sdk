...
// this prevents an empty or null value for this field from being omitted during serialization.
func (c *CreateAgentRequest) SetInstanceDetails(instanceDetails *v5.InstanceDetails) {
...
// SetInstanceDetails sets the InstanceDetails field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (u *UpdateAgentRequest) SetInstanceDetails(instanceDetails *v5.InstanceDetails) {
