...
func (r *RawClient) List(
...
) (*core.Response[*v5.EnrollmentList], error) {
	...
	endpointURL := baseURL + "/enrollments"
	...
	var response *v5.EnrollmentList
	...
	return &core.Response[*v5.EnrollmentList]{
