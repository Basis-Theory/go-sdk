...
type GetCredentialsRequest struct {
	...
	Merchant        *v5.AgenticMerchant `json:"merchant" url:"-"`
...
func (g *GetCredentialsRequest) SetProducts(products []*v5.Product) {
	g.Products = products
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (g *GetCredentialsRequest) SetMerchant(merchant *v5.AgenticMerchant) {
	g.Merchant = merchant
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (g *GetCredentialsRequest) SetAmount(amount *v5.Amount) {
	g.Amount = amount
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (g *GetCredentialsRequest) SetDeliveryMethod(deliveryMethod *v5.DeliveryMethod) {
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (g *GetCredentialsRequest) SetShippingAddress(shippingAddress *v5.ShippingAddress) {
