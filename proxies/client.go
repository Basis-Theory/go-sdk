...
func (c *Client) List(
...
) (*core.Page[*int, *basistheory.Proxy, *basistheory.ProxyPaginatedList], error) {
	...
	readPageResponse := func(response *basistheory.ProxyPaginatedList) *core.PageResponse[*int, *basistheory.Proxy, *basistheory.ProxyPaginatedList] {
		next += 1
		results := response.GetData()
		return &core.PageResponse[*int, *basistheory.Proxy, *basistheory.ProxyPaginatedList]{
			Results:  results,
			Response: response,
			Next:     &next,
		}
