...
func (r *RawClient) Get(
...
) (*core.Response[*v4.ApplePayMerchantCertificates], error) {
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/apple-pay/merchant-registration/%v/certificates/%v",
		merchantID,
		id,
	)
	...
	var response *v4.ApplePayMerchantCertificates
	...
	return &core.Response[*v4.ApplePayMerchantCertificates]{
...
func (r *RawClient) Create(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/apple-pay/merchant-registration/%v/certificates",
		merchantID,
	)
	headers := internal.MergeHeaders(
		r.header.Clone(),
