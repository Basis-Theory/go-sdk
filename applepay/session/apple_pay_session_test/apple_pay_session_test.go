...
package apple_pay_session_test
...
func TestApplePaySessionCreateWithWireMock(
	t *testing.T,
) {
	...
	_, invocationErr := client.ApplePay.Session.Create(
		context.TODO(),
		request,
		option.WithHTTPHeader(
			http.Header{"X-Test-Id": []string{"TestApplePaySessionCreateWithWireMock"}},
		),
	)

	require.NoError(t, invocationErr, "Client method call should succeed")
	VerifyRequestCount(t, "TestApplePaySessionCreateWithWireMock", "POST", "/apple-pay/session", nil, 1)
}
