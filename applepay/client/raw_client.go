...
func (r *RawClient) Create(
...
) (*core.Response[*v3.ApplePayCreateResponse], error) {
	...
	var response *v3.ApplePayCreateResponse
	...
	return &core.Response[*v3.ApplePayCreateResponse]{
...
func (r *RawClient) Get(
	...
	id string,
	opts ...option.RequestOption,
) (*core.Response[*v3.ApplePayToken], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*v3.ApplePayToken]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
