...
func (r *RawClient) Create(
...
) (*core.Response[*v2.CreateThreeDsSessionResponse], error) {
	...
	return &core.Response[*v2.CreateThreeDsSessionResponse]{
...
func (r *RawClient) Authenticate(
...
) (*core.Response[*v2.ThreeDsAuthentication], error) {
	...
	return &core.Response[*v2.ThreeDsAuthentication]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
...
func (r *RawClient) Get(
	...
	id string,
	opts ...option.RequestOption,
) (*core.Response[*v2.ThreeDsSession], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*v2.ThreeDsSession]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
