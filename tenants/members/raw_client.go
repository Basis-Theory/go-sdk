...
func (r *RawClient) List(
...
) (*core.Response[*v5.TenantMemberResponsePaginatedList], error) {
	...
	var response *v5.TenantMemberResponsePaginatedList
	...
	return &core.Response[*v5.TenantMemberResponsePaginatedList]{
