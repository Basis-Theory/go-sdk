...
func (r *RawClient) Get(
...
) (*core.Response[*basistheory.SecurityContactEmailResponse], error) {
	...
	var response *basistheory.SecurityContactEmailResponse
	...
	return &core.Response[*basistheory.SecurityContactEmailResponse]{
