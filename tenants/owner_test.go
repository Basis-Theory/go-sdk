...
func TestSettersTransferTenantOwnerRequest(t *testing.T) {
	t.Run("SetMemberID", func(t *testing.T) {
		obj := &TransferTenantOwnerRequest{}
...
func TestSettersMarkExplicitTransferTenantOwnerRequest(t *testing.T) {
