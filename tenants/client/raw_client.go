...
func (r *RawClient) Getsecuritycontact(
	ctx context.Context,
	opts ...option.RequestOption,
) (*core.Response[*v5.SecurityContactEmailResponse], error) {
	...
	endpointURL := baseURL + "/tenants/self/security-contact"
	...
	var response *v5.SecurityContactEmailResponse
	...
	return &core.Response[*v5.SecurityContactEmailResponse]{
...
func (r *RawClient) Updatesecuritycontact(
	ctx context.Context,
