...
func TestSettersSecurityContactEmailRequest(t *testing.T) {
	t.Run("SetEmail", func(t *testing.T) {
		obj := &SecurityContactEmailRequest{}
...
func TestSettersMarkExplicitSecurityContactEmailRequest(t *testing.T) {
